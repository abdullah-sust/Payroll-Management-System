            ...
            <section class="panel">
                <header class="panel-heading clearfix">
                    ...
                    <span class="pull-right">
                            <a class="btn btn-success btn-sm btn-new-user" href="{{ URL::route('designation.create') }}">Add Designation</a>
                    </span>
                </header>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    {{ Form::open(array('route' => array('designation.delete', 0), 'method'=> 'delete', 'class' => 'deleteForm')) }}
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
            ...
            $(document).on("click", ".deleteBtn", function() {
                ...
                var url = "<?php echo URL::route('designation.index'); ?>";
